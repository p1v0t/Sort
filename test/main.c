...
int main(void)
{
  ...
  /*  RANDOMIZE( );
    ...
    printf(
        ...
        "implementation\n");
    mergeSort(d, 0, ARRAYSIZE, sizeof(*d), cmp_func);
  ...
  printf(
      "Started testing correctness of Quick Sort with Lomuto\'s partition "
      "implementation\n");
  ...
  printf(
      "\nFinished testing correctness of Quick Sort with Lomuto\'s "
      "partition "
      "implementation\n\n");
